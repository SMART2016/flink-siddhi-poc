...
public class S3TokensParser extends Parser {
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public TerminalNode SimpleValue() {
            return getToken(S3TokensParser.SimpleValue, 0);
        }

        public TerminalNode DateValue() {
            return getToken(S3TokensParser.DateValue, 0);
        }

        public TerminalNode QuotedValue() {
            return getToken(S3TokensParser.QuotedValue, 0);
        }

        public TerminalNode DoubleQuotedValue() {
            return getToken(S3TokensParser.DoubleQuotedValue, 0);
        }
