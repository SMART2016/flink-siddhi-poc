package com.stackidentity.rae.app.connector.transformer;
...
public class JsonSchemaSerDe implements DeserializationSchema<JSONObject>, SerializationSchema<JSONObject> {
